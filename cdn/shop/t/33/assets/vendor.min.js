...
void 0 === window.Shopify && (window.Shopify = {}),
  ...
  (Shopify.formatMoney = function (t, e) {
    ...
    function i(t, e, i, o) {
      if (
        ((e = s(e, 2)), (i = s(i, ",")), (o = s(o, ".")), isNaN(t) || null == t)
      )
        return 0;
      t = (t = (t / 100).toFixed(e)).split(".");
      return (
        t[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + i) +
        (t[1] ? o + t[1] : "")
      );
    }
  ...
  (Shopify.OptionSelectors.prototype.replaceSelector = function (t) {
    ...
    Shopify.each(this.buildSelectors(), function (t) {
      null != e.querySelector(".js-product-form-variants") &&
        e.querySelector(".js-product-form-variants").append(t);
    }),
  ...
  (Shopify.OptionSelectorsFromDOM.prototype.createProductFromSelector =
    function (t, o, s, n) {
      Shopify.isDefined(s) || (s = !0), Shopify.isDefined(n) || (n = "/");
      var e = document.getElementById(t),
        t = e.childNodes,
        r = (e.parentNode, o.length),
        a = [];
      Shopify.each(t, function (t) {
        var e, i;
        1 == t.nodeType &&
          "option" == t.tagName.toLowerCase() &&
          ((e = t.innerHTML.split(new RegExp("\\s*\\" + n + "\\s*"))),
      ...
      if (0 == o.length) {
        i.options = [];
        for (var l = 0; l < r; l++) i.options[l] = "option " + (l + 1);
      } else i.options = o;
      return i;
    }),
  (Shopify.SingleOptionSelector = function (i, o, t, e) {
    ...
    for (var s = 0; s < e.length; s++) {
      ...
      (n.value = e[s]), (n.innerHTML = e[s]), this.element.appendChild(n);
    }
    return (
...
sameOrigin &&
  (function (t) {
    ...
    "function" == typeof define && define.amd && (define(t), (o = !0)),
      "object" == typeof exports && ((module.exports = t()), (o = !0)),
      o ||
        ((e = window.Cookies),
      ...
      function f(t, e, i) {
        ...
        if ("undefined" != typeof document) {
          if (1 < arguments.length) {
            "number" == typeof (i = m({ path: "/" }, f.defaults, i)).expires &&
          ...
          for (
            ...
            var p = a[c].split("=");
            '"' === (u = p.slice(1).join("=")).charAt(0) &&
              (u = u.slice(1, -1));
            try {
              var d = p[0].replace(l, decodeURIComponent),
                u = h.read
                  ? h.read(u, d)
                  : h(u, d) || u.replace(l, decodeURIComponent);
              if (this.json)
                try {
                  u = JSON.parse(u);
                } catch (t) {}
  ...
  (function (e, i) {
    ...
    function r(t, e, i) {
      ...
      var o,
        s = t;
      return (s = "string" == typeof t ? document.querySelectorAll(t) : s)
        ? ((this.elements =
            ((o = s),
            Array.isArray(o)
              ? o
    ...
    (o = 0),
      ...
      (r.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var s = e - 1, r = i, a = n.$slider.find(".slick-slide"), l = 0;
  ...
  (function (t) {
      ...
      open: function (t) {
        ...
        if (!f.isOpen) {
          (f.types = []),
            ...
            f.bgOverlay ||
              ((f.bgOverlay = d("bg").on("click" + k, function () {
                f.close();
              })),
              (f.wrap = d("wrap")
                .attr("tabindex", -1)
          ...
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? s.data("magnificPopup") : s[0].magnificPopup),
                ...
                (o = e.items
                  ? e.items[i]
                  : ((o = s), (o = e.delegate ? o.find(e.delegate) : o).eq(i))),
    ...
    function x() {
      T && (P.after(T.addClass(C)).detach(), (T = null));
    }
    var C,
      P,
      T,
          ...
          if ((x(), t.src)) {
            ...
            return (
              s.length
                ? ((i = s[0].parentNode) &&
                    i.tagName &&
                    (P || ((C = o.hiddenClass), (P = d(C)), (C = "mfp-" + C)),
    ...
    function M(t) {
      var e;
      !f.currTemplate[H] ||
        ((e = f.currTemplate[H].find("iframe")).length &&
          ...
          return (
            ...
            !(!n || !n.enabled) &&
              ...
              p("UpdateStatus" + t, function (t, e) {
                e.text &&
                  (e.text = B(e.text, f.currItem.index, f.items.length));
              }),
      ...
      return this.each(function () {
        ...
        function r() {
          ...
          n(o) &&
            ((t = 0),
            s.each(function () {
              n(this) || t || (e.appendTo(this), t++, (o = this));
            }));
        }
        r(), a(window).bind("resize", r);
      });
    };
  })(jQuery),
  (function (t, e) {
    ...
    return (
      (o = [
        ...
        function (t, e, i) {
          ...
          o.prototype = {
            ...
            registerPartial: function (t, e) {
              if (n.toString.call(t) === p) n.extend(this.partials, t);
              else {
                if (void 0 === e)
                  throw new r.default(
          ...
          i = s.default.log;
          (e.log = i), (e.createFrame = n.createFrame), (e.logger = s.default);
        },
        function (t, e) {
          "use strict";
          function i(t) {
            ...
            try {
              i &&
                ...
                c
                  ...
                  : ((this.column = n), (this.endColumn = e)));
            } catch (t) {}
          }
          var c = i(7).default;
          e.__esModule = !0;
        ...
        function (t, e, i) {
          ...
          (e.__esModule = !0),
            ...
            (e.moveHelperToHooks = function (t, e, i) {
              t.helpers[e] &&
                ((t.hooks[e] = t.helpers[e]), i || delete t.helpers[e]);
            });
          var s = o(i(11)),
            n = o(i(12)),
            r = o(i(25)),
          ...
          (e.default = function (s) {
            s.registerHelper("blockHelperMissing", function (t, e) {
              ...
              return !0 === t
                ...
                : n.isArray(t)
                ? 0 < t.length
                  ? (e.ids && (e.ids = [e.name]), s.helpers.each(t, e))
                  : i(this)
                : (e.data &&
                    e.ids &&
                    (((i = n.createFrame(e.data)).contextPath =
                      n.appendContextPath(e.data.contextPath, e.name)),
                    (e = { data: i })),
                  o(t, e));
            });
          }),
          ...
          !function (f) {
            ...
            (i.default = function (t) {
              t.registerHelper("each", function (o, t) {
                ...
                if (!t) throw new v.default("Must pass iterator to #each");
                var i,
                  s = t.fn,
                  n = t.inverse,
                  r = 0,
                ...
                if (
                  (t.data &&
                    t.ids &&
                    (c =
                      g.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
                  ...
                  if (g.isArray(o))
                    ...
                    for (
                      var d = [], u = o[f.Symbol.iterator](), h = u.next();
                      !h.done;
                      h = u.next()
                    )
                      d.push(h.value);
        ...
        function (t, e) {
          t = t.exports = { version: "1.2.6" };
          "number" == typeof __e && (__e = t);
        },
        function (t, e, i) {
          var n = i(23);
          t.exports = function (o, s, t) {
            if ((n(o), void 0 === s)) return o;
            switch (t) {
              case 1:
                return function (t) {
                  return o.call(s, t);
          ...
          (e.__esModule = !0),
            (e.default = function (s) {
              s.registerHelper("log", function () {
                for (
                  var t = [void 0], e = arguments[arguments.length - 1], i = 0;
                ...
                null != e.hash.level
                  ? (o = e.hash.level)
                  : e.data && null != e.data.level && (o = e.data.level),
                  (t[0] = o),
                  s.log.apply(s, t);
              });
            }),
          ...
          (e.default = function (t) {
            t.registerHelper("with", function (t, e) {
              ...
              return (
                e.data &&
                  e.ids &&
                  ((o = s.createFrame(e.data)).contextPath =
          ...
          var o = i(5),
            s = {
              ...
              lookupLevel: function (t) {
                ...
                return (t =
                  "string" == typeof t
                    ? 0 <= (e = o.indexOf(s.methodMap, t.toLowerCase()))
                      ? e
                      : parseInt(t, 10)
                    : t);
              },
        ...
        function (t, e, i) {
            ...
            function i(t) {
              ...
              return (
                ...
                s(
                  ...
                  o.partials,
                  e.data || n,
                  r && [e.blockParams].concat(r),
                  i
                )
              );
            }
            return (
              ((i = u(s, i, o, a, n, r)).program = t),
          ...
          function u(t, e, i, o, s, n) {
            return (
              t.decorator &&
                ((e = t.decorator(e, (t = {}), i, o && o[0], s, n, o)),
                h.extend(e, t)),
              e
            );
          }
          ...
          (e.__esModule = !0),
            (e.checkRevision = function (t) {
              ...
              if (
                !(
                  e >= m.LAST_COMPATIBLE_COMPILER_REVISION &&
                  e <= m.COMPILER_REVISION
                )
              ) {
                if (e < m.LAST_COMPATIBLE_COMPILER_REVISION) {
                  (i = m.REVISION_CHANGES[i]), (e = m.REVISION_CHANGES[e]);
                  throw new f.default(
            ...
            (e.template = function (l, c) {
                ...
                d = {
                  ...
                  lookupProperty: function (t, e) {
                    ...
                    return null == i ||
                      ...
                      y.resultIsAllowed(i, d.protoAccessControl, e)
                      ? i
                      : void 0;
                  },
                  lookup: function (t, e) {
                  ...
                  invokePartial: function (t, e, i) {
                    i.hash &&
                      ((e = h.extend({}, e, i.hash)), i.ids && (i.ids[0] = !0)),
              ...
              return (
                ...
                (p._setup = function (t) {
                  var e, o, s;
                  t.partial
                    ? ((d.protoAccessControl = t.protoAccessControl),
                      (d.helpers = t.helpers),
                      (d.partials = t.partials),
                      (d.decorators = t.decorators),
                      (d.hooks = t.hooks))
                    : ((e = h.extend({}, c.helpers, t.helpers)),
                      (s = d),
                      n((o = e)).forEach(function (t) {
                        ...
                        o[t] =
                          ...
                          v.wrapHelper(i, function (t) {
                            return h.extend({ lookupProperty: e }, t);
                          }));
                      }),
                      (d.helpers = e),
                      l.usePartial &&
                        (d.partials = d.mergeIfNeeded(t.partials, c.partials)),
                      (l.usePartial || l.useDecorators) &&
                        (d.decorators = h.extend(
                          {},
                          c.decorators,
                          t.decorators
                        )),
            ...
            (e.invokePartial = function (t, e, o) {
                      ...
                      function (t) {
                        var e =
                          arguments.length <= 1 || void 0 === arguments[1]
                            ...
                            : arguments[1];
                        return (
                          (e.data = m.createFrame(e.data)),
                          (e.data["partial-block"] = s),
                          i(t, e)
                        );
                      }),
                      i.partials &&
                        (o.partials = h.extend({}, o.partials, i.partials));
                  })(),
              ...
              if (t instanceof Function) return t(e, o);
            }),
            (e.noop = r);
          var h = s(i(5)),
            f = l(i(6)),
            ...
            (e.wrapHelper = function (e, i) {
              return "function" != typeof e
                ...
                : function () {
                    ...
                    return (
                      (arguments[arguments.length - 1] = i(t)),
        ...
        function (t, e) {
          ...
          var i = {
            helpers: {
              ...
              simpleId: function (t) {
                return (
                  1 === t.parts.length && !i.helpers.scopedId(t) && !t.depth
                );
              },
            },
          };
        ...
        function (t, e, i) {
          ...
          function o(t, e) {
            return "Program" === t.type
              ? t
              : (((r.default.yy = l).locInfo = function (t) {
          ...
          (e.__esModule = !0),
            ...
            (e.parse = function (t, e) {
              return (t = o(t, e)), new a.default(e).accept(t);
            });
          var r = s(i(47)),
            a = s(i(48)),
            n = n(i(50)),
          ...
          var i = (function () {
              ...
              i = {
                ...
                performAction: function (t, e, i, o, s, n, r) {
                  ...
                  switch (s) {
                    ...
                    case 22:
                    case 23:
                      this.$ = o.prepareMustache(
                        n[a - 3],
                        n[a - 2],
                        n[a - 1],
                        n[a - 4],
                        o.stripFlags(n[a - 4], n[a]),
                        this._$
                      );
                      break;
                    case 24:
                    ...
                    case 44:
                      ...
                      break;
                    case 45:
                      this.$ = [{ part: o.id(n[a]), original: n[a] }];
                      break;
                    case 46:
                      this.$ = [];
                      break;
            ...
            e = {
              ...
              unput: function (t) {
                ...
                return (
                  (this.yylloc = {
                    ...
                    last_column: i
                      ? (i.length === o.length ? this.yylloc.first_column : 0) +
                        o[o.length - i.length].length -
                        i[0].length
                      : this.yylloc.first_column - e,
                  }),
                  this.options.ranges &&
                    (this.yylloc.range = [t[0], t[0] + this.yyleng - e]),
                  this
                );
              },
              more: function () {
              ...
              next: function () {
                ...
                for (
                  var s = this._currentRules(), n = 0;
                  n < s.length &&
                  (!(e = this._input.match(this.rules[s[n]])) ||
                    (t && !(e[0].length > t[0].length)) ||
                    ((t = e), (i = n), this.options.flex));
                  n++
                );
                return t
                  ? ((o = t[0].match(/(?:\r\n?|\n).*/g)) &&
              ...
              performAction: function (t, i, e, o) {
                ...
                switch (e) {
                  ...
                  case 42:
                    return (
                      (i.yytext = i.yytext.replace(/\\([\\\]])/g, "$1")), 72
                    );
                  case 43:
                    return "INVALID";
                  case 44:
            ...
            return (i.lexer = e), new ((t.prototype = i).Parser = t)();
          })();
          (e.default = i), (t.exports = e.default);
        },
        function (t, e, i) {
              ...
              d &&
                ...
                e &&
                  ...
                  m(o, s) &&
                    ...
                    (p.indent = /([ \t]+$)/.exec(o[s - 1].original)[1])),
                e && a && (f((p.program || p.inverse).body), m(o, s)),
                e && l && (f(o, s), m((p.inverse || p.program).body)));
            }
            return t;
          }),
            (o.prototype.BlockStatement =
              ...
              o.prototype.PartialBlockStatement =
                function (t) {
                  ...
                  return (
                    t.openStrip.close && f(e.body, null, !0),
                    i
                      ? ((i = t.inverseStrip).open && m(e.body, null, !0),
                        ...
                        !this.options.ignoreStandalone &&
                          ...
                          h(o.body) &&
                          (m(e.body), f(o.body)))
                      : t.closeStrip.open && m(e.body, null, !0),
                    n
                  );
                }),
          ...
          (e.__esModule = !0),
            ...
            (e.preparePath = function (t, e, i) {
              ...
              for (
                ...
                if (
                  ...
                  if (0 < s.length)
                    throw new p.default("Invalid path: " + o, { loc: i });
                  ".." === l && n++;
                }
              }
              return {
            ...
            (e.prepareRawBlock = function (t, e, i, o) {
              return (
                ...
                (o = this.locInfo(o)),
                {
                  ...
                  params: t.params,
                  hash: t.hash,
                  program: { type: "Program", body: e, strip: {}, loc: o },
                  openStrip: {},
                  inverseStrip: {},
                  closeStrip: {},
                  loc: o,
            ...
            (e.prepareProgram = function (t, e) {
              ...
              return (
                ...
                { type: "Program", body: t, strip: {}, loc: e }
              );
            }),
        ...
        function (t, e, i) {
          ...
          o.prototype = {
            ...
            classifySexpr: function (t) {
              ...
              return (
                i &&
                  !o &&
                  ((e = t.path.parts[0]),
                  (t = this.options).knownHelpers[e]
                    ? (o = !0)
                    : t.knownHelpersOnly && (i = !1)),
            ...
            pushParam: function (t) {
              var e,
                i,
                o = null != t.value ? t.value : t.original || "";
              this.stringParams
                ? (o.replace &&
                ...
                : (this.trackIds &&
                    ((e = void 0),
                    (e =
                      !t.parts || c.default.helpers.scopedId(t) || t.depth
                        ? e
                        : this.blockParamIndex(t.parts[0]))
                      ? ((i = t.parts.slice(1).join(".")),
                        this.opcode("pushId", "BlockParam", e, i))
                      : ((o = t.original || o).replace &&
                          (o = o
                            .replace(/^this(?:\.|$)/, "")
                            .replace(/^\.\//, "")
                            .replace(/^\.$/, "")),
        ...
        function (t, e, i) {
          ...
          (s.prototype = {
            ...
            compile: function (t, e, i, o) {
              ...
              var c = { compiler: this.compilerInfo(), main: t };
              this.decorators &&
                ((c.main_d = this.decorators), (c.useDecorators = !0));
              var t = this.context,
                p = t.programs,
                d = t.decorators;
              for (a = 0, l = p.length; a < l; a++)
                p[a] &&
                  ((c[a] = p[a]),
                  d[a] && ((c[a + "_d"] = d[a]), (c.useDecorators = !0)));
              return (
            ...
            createFunctionContext: function (t) {
              ...
              return t
                ? (n.push(e), Function.apply(this, n))
                : this.source.wrap([
                    "function(",
                    n.join(","),
                    ") {\n  ",
                ...
                this.push(
                  (function (t, e, i, o) {
                    var s = e.popStack(),
                      n = 0,
                      r = i.length;
                    for (t && r--; n < r; n++) s = e.nameLookup(s, i[n], o);
                    return t
                      ? [
            ...
            invokeHelper: function (t, e, i) {
              ...
              i && e.push(t.name),
                e.push(o),
                this.options.strict ||
                  e.push(this.aliasable("container.hooks.helperMissing"));
            ...
            invokeAmbiguous: function (t, e) {
              ...
              this.options.strict ||
                ...
                this.push([
                  "(",
                  i,
                  e.paramsInit ? ["),(", e.paramsInit] : [],
                  "),",
                  "(typeof helper === ",
                  this.aliasable('"function"'),
                  " ? ",
                  this.source.functionCall("helper", "call", e.callParams),
                  " : helper))",
                ]);
            },
            invokePartial: function (t, e, i) {
            ...
            compileChildren: function (t, e) {
              for (
                var i = t.children, o = void 0, s = void 0, n = 0, r = i.length;
                n < r;
                n++
              ) {
                var a,
                  o = i[n],
                  s = new this.compiler(),
                  l = this.matchExistingProgram(o);
                null == l
                  ? (this.context.programs.push(""),
                    (a = this.context.programs.length),
                    (o.index = a),
                    (o.name = "program" + a),
                    (this.context.programs[a] = s.compile(
                      o,
                      e,
                      this.context,
                      !this.precompile
            ...
            matchExistingProgram: function (t) {
              for (
                var e = 0, i = this.context.environments.length;
                e < i;
                e++
              ) {
            ...
            push: function (t) {
              return (
                t instanceof a || (t = this.source.wrap(t)),
            ...
            popStack: function (t) {
              ...
              if (!t && i instanceof a) return i.value;
              if (!e) {
            ...
            setupParams: function (t, e, i) {
              ...
              for (var p = e; p--; )
                (o = this.popStack()),
                  ...
                  this.stringParams &&
                    ((r[p] = this.popStack()), (n[p] = this.popStack()));
              return (
                l && (s.args = this.source.generateArray(i)),
            ...
            (s.isValidJavaScriptVariableName = function (t) {
              return (
                !s.RESERVED_WORDS[t] && /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(t)
              );
            }),
            (e.default = s),
            (t.exports = e.default);
