  ...
  var e = {
      ...
      3249: function (e, t, n) {
        ...
        t.updateTrackingConsent = function (e, t) {
          ...
          function i(r, i) {
            ...
            var s;
            0 === (s = n.status) || (200 >= s && s < 400)
              ? (o.dispatchEvents(e), void 0 !== t && t(null, a), r(a))
              : (void 0 !== t && t(a), i({ response: a, code: n.status }));
          }
          return (
            ...
            t
              ? ((n.onreadystatechange = () =>
                ...
                void n.send(r))
              : new Promise((e, t) => {
                  (n.onreadystatechange = () => i(e, t)), n.send(r);
                })
          );
        };
      },
        ...
        (t.CONSENT_COOKIE_NAME = a),
          ...
          (t.setStorefrontApiTrackingConsent = function (e, t) {
            ...
            const r = {
              ...
              s = { v: o.CookieVersion, reg: "", con: { CMP: r } },
              c = encodeURIComponent(JSON.stringify(s));
            return (
              i.writeCookie(a, e.rootDomain, 31536e6, c),
              t(null),
              new Promise((e, t) => {})
            );
          }),
      ...
      8920: function (e, t, n) {
        ...
        (t.saleOfDataRegion = i.saleOfDataRegion),
          ...
          (t.setCCPAConsent = function (e, t) {
            ...
            return a.updateTrackingConsent(
          ...
          (t.setTrackingConsent = function (e, t) {
            ...
            const r = (function (e) {
              ...
              i = u(n.analytics),
              c = !!document.querySelector("[data-pam-a89c=true]");
            return (
              n.storefrontAccessToken || n.metafields || c
                ? s.storefrontApiUpdateTrackingConsent
                : a.updateTrackingConsent
            )(
              {
                granular_consent: n,
                ...(null !== r && { referrer: r }),
          ...
          (t.shouldShowCCPABanner = function () {
            return (
              ...
              i.saleOfDataRegion() &&
                f() === o.DisplayConsentValues.NO_INTERACTION
            );
          }),
          (t.shouldShowGDPRBanner = function () {
            return (
              i.shouldShowBanner() &&
              c() === o.DisplayConsentValues.NO_INTERACTION
            );
          }),
      ...
      5542: function (e, t, n) {
        ...
        function c(e) {
          ...
          return {
            query: `query { consentManagement { cookies(${s.objectToGraphQL(
              t
            )}) { answersCookie trackingConsentCookie cookieDomain } } }`,
            variables: {},
          };
        }
        t.storefrontApiUpdateTrackingConsent = function (e, t) {
          const n = e.granular_consent,
            ...
            u = n.checkoutRootDomain || window.location.host,
            d = {
              headers: {
          ...
          return fetch(`https://${u}/api/unstable/graphql.json`, d)
            .then((e) => {
            ...
            .then((s) => {
              const c = 31536e6,
                u = s.data.consentManagement.cookies.cookieDomain,
                d =
                  "." + (n.checkoutRootDomain || u || window.location.hostname),
                p =
                  "." +
                  (n.storefrontRootDomain || u || window.location.hostname),
                l = s.data.consentManagement.cookies.trackingConsentCookie,
                f = s.data.consentManagement.cookies.answersCookie;
              return (
                r.writeCookie(i.CONSENT_COOKIE_NAME, d, c, l),
                r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, d, c, f),
                p !== d &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, p, c, l),
                  r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, p, c, f)),
                o.dispatchEvents(e),
                void 0 !== t && t(null, s),
                s
              );
        ...
        var y = (function (e) {
          ...
          return (
            ...
            (n.prototype.addedProductNext = function (e) {
              if (this.hasCartLines(e.properties)) {
                var n = e.properties.cartLines;
                ...
                var o = n.reduce(function (e, t) {
                  ...
                  r = {
                    event_id: e.eventId,
                    products: this.formatProductJSON(n),
                    total_value: this.formatRevenue(o),
                    currency: this.getCurrency(n[0].currency),
                    cart_token: n[0].cartToken,
                  };
                this.produceToMonorail({
            ...
            (n.prototype.eventWithMetadata = function (e, t, n) {
              ...
              return i(i({}, t), {
                ...
                asset_version_id: "6feac1db1e2c7d84269967dcaefdee0618af51f6",
            ...
            (n.prototype.hasCartLines = function (e) {
              return e && Array.isArray(e.cartLines);
            }),
            (n.defaultOptions = {
              facebookAppPixelId: "",
          ...
          if (void 0 === o)
            if (
              ...
              for (
                ...
                if ((g(e, a, 0, t), y(e, a))) return void (o = t);
              }
              o = "";
            }
        }
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "6feac1db1e2c7d84269967dcaefdee0618af51f6",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
          ...
          g = (function () {
            function e(e, t, n) {
              ...
              (this.integrations = []),
                ...
                y.default.initialize(t.Trekkie.enabledBetaFlags),
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                a.addBatchEvent({
                  ...
                  payload: {
                    build_id: "6feac1db1e2c7d84269967dcaefdee0618af51f6",
      ...
      803: function (e, t, n) {
        ...
        const o = "sh",
          ...
          g = "checkout_shipping_info_submitted",
    ...
    (function () {
      ...
      try {
        ...
        if (h) {
          ...
          var v = window[r],
            y = (window.trekkie = new e.Tricorder(i, h, function () {
              (window[r] = y),
                (window._visit = {
                  tag: function () {},
